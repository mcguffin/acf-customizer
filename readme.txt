...
You can can either go into the Support forum, or in the [acf-customizer Repository](https://github.com//acf-customizer).

= I'd like to suggest a feature. Where should I post it? =

I personally prefer GitHub. The plugin code is here: [GitHub](https://github.com//acf-customizer)
(See above as well.)
...
3. type `git clone git@github.com:/acf-customizer.git`
...
Either post it on the [GitHub-repo](https://github.com//acf-customizer) or—if you cloned the repository—send me a pull request.
